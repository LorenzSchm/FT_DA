...
// ─── Types ───────────────────────────────────────────────────────────
export type Intent = "CREATE" | "READ" | "UPDATE" | "DELETE" | "CONFIRM" | "UNKNOWN";
...
// ─── Keyword maps ────────────────────────────────────────────────────
const CREATE_KEYWORDS = ["add", "create", "new", "insert", "log", "record", "make"];
const READ_KEYWORDS = ["show", "list", "display", "get", "view", "what", "how much", "balance", "total", "summary"];
const UPDATE_KEYWORDS = ["change", "update", "edit", "modify", "set", "rename"];
const DELETE_KEYWORDS = ["delete", "remove", "cancel", "erase"];
const CONFIRM_KEYWORDS = ["yes", "yeah", "yep", "sure", "confirm", "ok", "okay", "do it", "go ahead", "y"];
const DENY_KEYWORDS = ["no", "nah", "nope", "cancel", "stop", "don't", "abort", "n"];

const EXPENSE_KEYWORDS = ["expense", "spending", "spent", "cost", "payment", "pay", "bought", "purchase"];
const INCOME_KEYWORDS = ["income", "salary", "earning", "earned", "received", "deposit", "paycheck", "bonus", "revenue"];
...
export function formatCurrency(amountMinor: number, currency: string = "EUR"): string {

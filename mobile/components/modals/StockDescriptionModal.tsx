...
import { Animated, Dimensions, Modal, PanResponder, View, TouchableOpacity, Text, ScrollView, Platform } from "react-native";
...
export default function StockDescriptionModal({ isVisible, onClose, description }: Props) {

...
export default function SellInvestmentModal({
    ...
    const currentPrice = selectedStock?.current_price ?? selectedStock?.price ?? 0;
    ...
    const handleSell = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${API_BASE}/investments/sell`, payload, {
                headers: {
                    ...
                    <SafeAreaView style={{ flex: 1 }}>
                        ...
                        <View style={{ flex: 1, justifyContent: "space-between" }}>
                            ...
                            <View className="mb-16">
                                ...
                                <TouchableOpacity
                                    className={`bg-red-600 rounded-full py-4 ${isButtonDisabled ? "opacity-60" : ""
                                        }`}
                                    onPress={handleSell}

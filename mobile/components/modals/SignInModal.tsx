import {Image, Modal, Text, TextInput, TouchableOpacity, View, Animated} from "react-native";
        ...
        >
            <View className="flex-1 justify-end">
                ...
                <View className="h-1/2 bg-white rounded-t-3xl p-6">
                    <Text className="text-2xl text-gray-400">Log In</Text>
                    <View>
                        <Animated.View
                            style={{
                                transform: [
                        ...
                        >
                            <SignInForm isVisible={formIsVisible} email={email}/>
                        </Animated.View>
                    </View>
                </View>
            </View>

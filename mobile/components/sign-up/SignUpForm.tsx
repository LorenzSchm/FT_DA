import {Text, TextInput, TouchableOpacity, View, StyleSheet} from "react-native"; // Changed import
...
export default function SignUpForm({isVisible, email}: Props) {
    ...
    const validateRepeatPassword = (password: string, repeat: string): string | undefined => {
            ...
            {state === STATE.FIRST ? (
                <View className="flex flex-col gap-[20px]">
                    <View>
                        <TextInput
                            ...
                            autoCapitalize="none"
                        />
                        {errors.email && <Text className="text-red-500 text-[14px] mt-1">{errors.email}</Text>}
                    </View>
                    ...
                    <View>
                        <TextInput
                            ...
                            secureTextEntry
                        />
                        {errors.password && <Text className="text-red-500 text-[14px] mt-1">{errors.password}</Text>}
                    </View>
                    ...
                    <View>
                        ...
                        {errors.repeatPassword && (
                            <Text className="text-red-500 text-[14px] mt-1">{errors.repeatPassword}</Text>
                        )}
                    </View>
                ...
                <View className="flex flex-col gap-[20px]">
                    <View>
                        ...
                        />
                        {errors.firstName && <Text className="text-red-500 text-[14px] mt-1">{errors.firstName}</Text>}
                    </View>
                    ...
                    <View>
                        ...
                        />
                        {errors.lastName && <Text className="text-red-500 text-[14px] mt-1">{errors.lastName}</Text>}
                    </View>
                    ...
                    <View>
                        ...
                        />
                        {errors.phone && <Text className="text-red-500 text-[14px] mt-1">{errors.phone}</Text>}
                    </View>

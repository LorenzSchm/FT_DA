            ...
            {state === STATE.FIRST ? (
                <View className="flex flex-col gap-[20px]">
                    ...
                    <View className="flex flex-row items-center justify-center gap-2">
                        ...
                        <TouchableOpacity onPress={handleContinue} className="bg-gray-400 h-[7px] w-[7px] rounded-full"/>
                    </View>
                ...
                <View className="flex flex-col gap-[20px]">
                    ...
                    <View className="flex flex-row items-center justify-center gap-2">
                        <TouchableOpacity onPress={() => setState(STATE.FIRST)} className="bg-gray-400 h-[7px] w-[7px] rounded-full"/>
                        <View className="bg-black h-[7px] w-[7px] rounded-full"/>
                    </View>

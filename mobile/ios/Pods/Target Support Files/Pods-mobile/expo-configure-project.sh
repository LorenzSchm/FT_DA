...
with_node \
  ...
  --target "/Users/lorenzschmidt/PycharmProjects/FT_DA/mobile/ios/Pods/Target Support Files/Pods-mobile/ExpoModulesProvider.swift" \
  --entitlement "/Users/lorenzschmidt/PycharmProjects/FT_DA/mobile/ios/mobile/mobile.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"

...
const PrivacyPolicyTextView = () => {
  return (
    <div className="h-full max-w-4xl mx-auto p-6 bg-white  rounded-lg">
      ...
      <ul className="list-disc pl-6 mb-4 text-gray-700">
        ...
        <li className="mb-2">
          <strong>Application</strong> refers to Finance Tracker, the software
          program provided by the Company.
        </li>
        <li className="mb-2">
          <strong>Company</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
          this Agreement) refers to Finance Tracker.
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <strong>Website</strong> refers to Finance Tracker, accessible from{" "}
          <a

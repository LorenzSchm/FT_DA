        ...
        <div>
            <div className="mt-20 justify-center gap-36 flex flex-row">
                <div ref={textRef}>
                    ...
                    >
                        <button
                            className="text-lg mt-2 font-bold text-white px-5 py-1 rounded-3xl bg-white/20 border-2 border-solid border-white/50 hover:cursor-pointer hover:border-white/70">
                            Start Saving
                        </button>
                    </motion.div>
                </div>

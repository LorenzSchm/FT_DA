    ...
    return (
        <div>
            ...
            >
                    ...
                    <div>
                        ...
                        <div>
                            <p className="text-white font-swiss font-medium">
                                The Finance Tracker is a user-friendly mobile app that <br/> helps
                                you manage your finances efficiently. With our <br/> platform, you
                                can keep track of your income, expenses,
                ...
                <div className={"flex flex-col gap-2 justify-center items-center lg:mt-10 sm:mt-60 md:mt-72"}>
                    <span
                        className="inline-block w-2 h-2 bg-white rounded-full mx-1 transition-all duration-300 hover:w-5 hover:h-5"/>
                    <span
                        className="inline-block w-3 h-3 bg-white rounded-full mx-1 transition-all duration-300 hover:w-5 hover:h-5"/>
                    <span
                        className="inline-block w-4 h-4 bg-white rounded-full mx-1 transition-all duration-300 hover:w-5 hover:h-5"/>
                </div>
                <div>
                    <CardView/>
                </div>
